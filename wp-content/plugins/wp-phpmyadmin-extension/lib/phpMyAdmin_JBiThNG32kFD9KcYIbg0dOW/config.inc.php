...
$cfg['blowfish_secret']					= 'B<8.BSfZlKcT9$T\\E}YRX+p#H\"0_vy>8' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_JBiThNG32kFD9KcYIbg0dOW/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
